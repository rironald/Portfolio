  ...
  return (
    <div className="max-w-7xl mx-auto pt-60 md:py-40">
      <div>
        ...
        <div className="mx-auto px-6 pb-4 max-w-2xl">
          <form>
            ...
            <div className="mt-6 flex items-center justify-end gap-x-6">
              ...
              <button
                type="submit"
                className=" px-6 py-2 text-sm font-semibold text-black shadow-sm border border-black rounded-3xl hover:bg-black hover:text-white"
              >
                Send
              </button>
            </div>
